...
Game::Game() :
	...
	game_over_screen(GAME_OVER_FILE_NAME, 1.351f, 2.135),
	road1(0.f, 0.f),
	road2(0.f, -WINDOW_HEIGHT),
	barrier1(0.f, -barrier1.getHitBox().height),
	barrier2(200.f, -WINDOW_HEIGHT / 2),
	score_text("ds-digib.ttf", 20, 10, 10, sf::Color::Red)
{
...
void Game::update() {
	...
	case PLAY:
		...
		barrier1.update();
		barrier2.update();
		score_text.update(std::to_string(barrier1.getScore()+barrier2.getScore()));
		break;
	case GAME_OVER:
		break;
	}
